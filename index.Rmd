...
In addition, we provide full tables for all the regression models in our main text and the Online SI.
...
Content in S6 of the Online SI can be found in the top menu under the section *Analyses of the additional sample (N = 980)*.
